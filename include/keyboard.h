...
extern KeyState keyboardState[128];

extern bool ShiftPressed();
extern bool KbIsBufferEmpty();
extern bool IsPrintable(unsigned char keycode);
extern void KbAddKeyToBuffer(char key);
extern void KeyboardHandlerMain();
void KeyboardFlush();
